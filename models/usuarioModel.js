...
class UsuarioModel {
    ...
    async obterPorEmailSenha(email, senha) {
        let sql = "select * from tb_usuarioadocao where usu_email = ? and usu_senha = ?";
    ...
    async listar() {
        ...
        let sql = "select * from tb_usuarioadocao";
    ...
    async cadastrar() {
        if(this.#usuarioId == 0) {
            let sql = "insert into tb_usuarioadocao (usu_email, usu_nome, usu_senha, usu_ativo, per_id) values (?,?,?,?,?)";
            ...
            let sql = "update tb_usuarioadocao set usu_email = ?, usu_nome = ?, usu_senha = ?, usu_ativo = ?, per_id = ? where usu_id = ?";
    ...
    async obter(id) {
        let sql = "select * from tb_usuarioadocao where usu_id = ?";
    ...
    async excluir(id) {
        let sql = "delete from tb_usuarioadocao where usu_id = ?";
